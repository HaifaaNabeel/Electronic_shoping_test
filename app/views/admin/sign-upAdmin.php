  ...
  <body class="bg-light-gray" id="body">
                  ...
                  <form action="/index.html">
                    <div class="row">
                      <div class="form-group col-md-12 mb-4">
                        <input type="text" class="form-control input-lg" id="user_name" aria-describedby="nameHelp" placeholder="Name">
                      </div>
                      <div class="form-group col-md-12 mb-4">
                        <input type="email" class="form-control input-lg" id="user_email" aria-describedby="emailHelp" placeholder="Username">
                      </div>
                      <div class="form-group col-md-12 ">
                        <input type="password" class="form-control input-lg" id="user_pass" placeholder="Password">
                      </div>
                      <div class="form-group col-md-12 ">
          ...
          <footer>
            <div class="copyright bg-white ">
              <p>
                &copy; <span id="copy-year">2019</span> Copyright for
                <a
                  class="text-primary"
                  href="#"
                  target="_blank"
